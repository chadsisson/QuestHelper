...
import net.runelite.client.plugins.custom.QuestHelper.steps.ObjectStep;
...
import net.runelite.client.plugins.custom.QuestHelper.steps.TileStep;
...
public class ErnestPuzzleStep extends QuestStep implements OwnerStep
{
	...
	{
		if (client.getVar(Varbits.ERNEST))
		if (client.getVar(Varbits.QUEST_ERNEST_LEVER_A) == a
			&& client.getVar(Varbits.QUEST_ERNEST_LEVER_B) == b
			&& client.getVar(Varbits.QUEST_ERNEST_LEVER_C) == c
			&& client.getVar(Varbits.QUEST_ERNEST_LEVER_D) == d
			&& client.getVar(Varbits.QUEST_ERNEST_LEVER_E) == e
			&& client.getVar(Varbits.QUEST_ERNEST_LEVER_F) == f)
		{
			return true;
		}
